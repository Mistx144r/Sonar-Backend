...
CREATE TABLE `follows` (
  ...
  CONSTRAINT `followedArtistId` FOREIGN KEY (`followedId`) REFERENCES `artists` (`id`) ON DELETE CASCADE,
  CONSTRAINT `followedUserId` FOREIGN KEY (`followedId`) REFERENCES `users` (`id`) ON DELETE CASCADE,
